...
class ZDT1Test : public ::testing::Test {
   protected:
    ...
    ZDT1 zdt{10};
    static constexpr std::array<std::array<double, 2>, 10> F = {
        {{0.417022004702574, 2.4821992632522214},
...
class ZDT2Test : public ::testing::Test {
   protected:
    ...
    ZDT2 zdt{10};
    static constexpr std::array<std::array<double, 2>, 10> F = {
        {{0.417022004702574, 3.6826380049007597},
...
class ZDT3Test : public ::testing::Test {
   protected:
    ...
    ZDT3 zdt{10};
    static constexpr std::array<std::array<double, 2>, 10> F = {
        {{0.417022004702574, 2.269669701992888},
...
class ZDT4Test : public ::testing::Test {
   protected:
    ...
    ZDT4 zdt{10};
    static constexpr std::array<std::array<double, 2>, 10> F = {
        {{0.417022004702574, 90.85247661260021},
...
class ZDT6Test : public ::testing::Test {
   protected:
    ...
    ZDT6 zdt{10};
    static constexpr std::array<std::array<double, 2>, 10> F = {
        {{0.8114180480067016, 7.592981519342151},
