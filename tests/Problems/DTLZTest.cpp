...
class DTLZ1Test : public ::testing::Test {
   protected:
    ...
    DTLZ1 dtlz{10, 3};
    std::vector<std::vector<double>> F = {{103.98274008198233, 40.37267338603425, 201.80237158932806},
...
class DTLZ2Test : public ::testing::Test {
   protected:
    ...
    DTLZ2 dtlz{10, 3};
    std::vector<std::vector<double>> F = {{0.578229429594233, 1.2304276116901565, 1.044404440123023},
...
class DTLZ3Test : public ::testing::Test {
   protected:
    ...
    DTLZ3 dtlz{10, 3};
    std::vector<std::vector<double>> F = {{233.5062116999207, 496.88320184319974, 421.76152200838465},
...
class DTLZ4Test : public ::testing::Test {
   protected:
    ...
    DTLZ4 dtlz{10, 3};
    std::vector<std::vector<double>> F = {{1.7143751093057493, 1.5242070952292778e-14, 2.7933341971441054e-38},
...
class DTLZ5Test : public ::testing::Test {
   protected:
    ...
    DTLZ5 dtlz{10, 3};
    std::vector<std::vector<double>> F = {{0.8131929080076364, 1.0895038665486683, 1.044404440123023},
...
class DTLZ6Test : public ::testing::Test {
   protected:
    ...
    DTLZ6 dtlz{10, 3};
    std::vector<std::vector<double>> F = {{2.775362246805014, 5.260703899669196, 4.569269264285234},
...
class DTLZ7Test : public ::testing::Test {
   protected:
    ...
    DTLZ7 dtlz{10, 3};
    std::vector<std::vector<double>> F = {{0.417022004702574, 0.7203244934421581, 11.58976537719187},
