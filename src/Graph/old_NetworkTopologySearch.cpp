...
bool old_NetworkTopologySearch::Evaluation::operator<(
...
std::ostream& operator<<(std::ostream& os,
                         const old_NetworkTopologySearch::Evaluation& eval) {
...
void old_NetworkTopologySearch::Run(int repeats, double initialTemperature,
...
void old_NetworkTopologySearch::Initialize() {
    InitializeNodes();
...
void old_NetworkTopologySearch::Search(int repeats, double initialTemperature,
...
void old_NetworkTopologySearch::Analyze(
...
void old_NetworkTopologySearch::Write(
...
old_NetworkTopologySearch::Evaluation
old_NetworkTopologySearch::BestSoFarEvaluation() const {
    return _bestSoFarEvaluation;
}

SimpleGraph old_NetworkTopologySearch::BestSoFarGraph() const {
    return _bestSoFarGraph;
}

old_NetworkTopologySearch::Evaluation old_NetworkTopologySearch::Evaluate(
...
void old_NetworkTopologySearch::EvaluateSqls(
...
void old_NetworkTopologySearch::InitializeNodes() {
...
bool old_NetworkTopologySearch::AcceptanceCriterion(double newObjective,
                                                    double oldObjective,
...
void old_NetworkTopologySearch::UpdateTemperature(double& temperature,
                                                  double minTemperature,
