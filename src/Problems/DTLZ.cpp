...
int DTLZBase::DecisionVariablesNum() const { return _decisionVariablesNum; }

int DTLZBase::ObjectivesNum() const { return _objectivesNum; }
...
double DTLZ6::G(const Eigen::ArrayXd& XM) const { return XM.pow(0.1).sum(); }
