...
class MpMoeadIdealTopology : public IMoead<DecisionVariableType> {
   public:
    ...
    MpMoeadIdealTopology(int generationNum, int neighborhoodSize, int divisionsNumOfWeightVector, int migrationInterval,
                         std::string idealTopologyFilePath, const std::shared_ptr<ICrossover<DecisionVariableType>>& crossover,
                         ...
                         const std::shared_ptr<ISelection>& selection, bool idealPointMigration = false)
...
#ifdef _TEST_
   public:
    MpMoeadIdealTopology(int totalPopulationSize, int generationNum, int decisionVariableNum, int objectiveNum, int neighborNum,
...
template <typename DecisionVariableType>
std::vector<Eigen::ArrayXd> MpMoeadIdealTopology<DecisionVariableType>::GetObjectivesList() const {
...
template <typename DecisionVariableType>
std::vector<Eigen::ArrayX<DecisionVariableType>> MpMoeadIdealTopology<DecisionVariableType>::GetSolutionList() const {
...
template <typename DecisionVariableType>
std::pair<std::vector<int>, std::vector<int>> MpMoeadIdealTopology<DecisionVariableType>::GenerateExternalNeighborhood(
...
template <typename DecisionVariableType>
std::vector<double> MpMoeadIdealTopology<DecisionVariableType>::GetWeightVectorsMatchingIndexes(
...
template <typename DecisionVariableType>
void MpMoeadIdealTopology<DecisionVariableType>::CalculateRanksToSent(const std::vector<int>& neighborhoodIndexes,
...
template <typename DecisionVariableType>
std::vector<std::vector<double>> MpMoeadIdealTopology<DecisionVariableType>::ScatterPopulation() {
...
template <typename DecisionVariableType>
void MpMoeadIdealTopology<DecisionVariableType>::InitializeIndividualAndWeightVector(
...
template <typename DecisionVariableType>
void MpMoeadIdealTopology<DecisionVariableType>::MakeLocalCopyOfExternalIndividuals() {
    for (auto&& i : externalIndexes) {
...
template <typename DecisionVariableType>
std::vector<Individual<DecisionVariableType>> MpMoeadIdealTopology<DecisionVariableType>::SelectParents(int index) {
...
template <typename DecisionVariableType>
Individual<DecisionVariableType> MpMoeadIdealTopology<DecisionVariableType>::GenerateNewIndividual(int index) {
...
template <typename DecisionVariableType>
void MpMoeadIdealTopology<DecisionVariableType>::UpdateNeighboringIndividuals(int index,
...
template <typename DecisionVariableType>
void MpMoeadIdealTopology<DecisionVariableType>::UpdateIdealPoint(const Eigen::ArrayXd& objectives) {
...
template <typename DecisionVariableType>
void MpMoeadIdealTopology<DecisionVariableType>::UpdateIdealPointWithMessage(const std::vector<double>& message) {
...
template <typename DecisionVariableType>
std::unordered_map<int, std::vector<double>> MpMoeadIdealTopology<DecisionVariableType>::CreateMessages() {
...
template <typename DecisionVariableType>
std::vector<std::vector<double>> MpMoeadIdealTopology<DecisionVariableType>::ReceiveMessages() {
    std::vector<std::vector<double>> receiveMessages;
...
template <typename DecisionVariableType>
void MpMoeadIdealTopology<DecisionVariableType>::UpdateWithMessage(std::vector<double>& message) {
