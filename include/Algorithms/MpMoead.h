...
MpMoead<DecisionVariableType>::GetSolutionList() const {
...
MpMoead<DecisionVariableType>::GenerateExternalNeighborhood(
...
template <typename DecisionVariableType>
std::vector<double>
MpMoead<DecisionVariableType>::GetWeightVectorsMatchingIndexes(
    std::vector<double>& weightVectors, std::vector<int>& indexes) {
...
template <typename DecisionVariableType>
void MpMoead<DecisionVariableType>::InitializeExternalPopulation(
...
template <typename DecisionVariableType>
void MpMoead<DecisionVariableType>::CalculateRanksToSent(
...
MpMoead<DecisionVariableType>::ScatterPopulation() {
...
MpMoead<DecisionVariableType>::SelectParents(int index) {
...
MpMoead<DecisionVariableType>::GenerateNewIndividual(int index) {
    std::vector<Individual<DecisionVariableType>> parents =
        SelectParents(index);
...
template <typename DecisionVariableType>
void MpMoead<DecisionVariableType>::UpdateNeighboringIndividuals(
    int index, Individual<DecisionVariableType>& newIndividual) {
...
template <typename DecisionVariableType>
void MpMoead<DecisionVariableType>::UpdateIdealPoint(
...
template <typename DecisionVariableType>
void MpMoead<DecisionVariableType>::UpdateIdealPointWithMessage(
...
MpMoead<DecisionVariableType>::CreateMessages() {
...
template <typename DecisionVariableType>
std::vector<std::vector<double>>
MpMoead<DecisionVariableType>::ReceiveMessages() {
    std::vector<std::vector<double>> receiveMessages;
...
template <typename DecisionVariableType>
void MpMoead<DecisionVariableType>::UpdateWithMessage(
